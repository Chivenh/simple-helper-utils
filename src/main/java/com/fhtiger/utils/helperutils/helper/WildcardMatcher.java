...
/**
 * 复制于com.opensymphony.xwork2.util.WildcardHelper
 * 
 * @author LuoGang
 *
 */
public class WildcardMatcher {
	 ...
	 * more characters (excluding the path separator '/') are to be matched.
	 * </li>
	 *
	 * <li>The '**' sequence is converted to MATCH_PATH, meaning that zero or
	 * more characters (including the path separator '/') are to be matched.
	 * </li>
	 *
	 ...
	 *
	 * @param map
	 *            The map to store matched values
	 * @param data
	 *            The string to match
	 * @param expr
	 ...
	 *            The index of the first character in r to look for.
	 * @param rend
	 *            The index of the last character in r to look for.
	 * @param d
